...
#ifndef STORAGE_LEVELDB_UTIL_WASI_LOGGER_H_
#define STORAGE_LEVELDB_UTIL_WASI_LOGGER_H_
  ...
  void Logv(const char* format, std::va_list arguments) override {
    ...
    for (int iteration = 0; iteration < 2; ++iteration) {
      ...
      int buffer_offset = std::snprintf(
          buffer, buffer_size, "%04d/%02d/%02d-%02d:%02d:%02d.%06d  ",
      ...
      // 3 delimiters)
      assert(buffer_offset <= 28);
      static_assert(28 < kStackBufferSize,
...
#endif  // STORAGE_LEVELDB_UTIL_WASI_LOGGER_H_